...
INSERT INTO public.users (id, "name", phone_number, email, status, authority, "password", tenant_id, remark, additional_info, created_at, updated_at) VALUES('11111111-4fe9-b409-67c3-111111111111', 'Tenant', '17366666666', 'test@qq.com', 'N', 'TENANT_ADMIN', '$2a$10$Zj.RmyvgzGFKTAxrYCjXRumT2XxSl4nUs4h0vONia2tytIofIrg3e', 'd616bcbb', '', '{}'::json, '2024-06-05 16:48:11.097', '2024-06-05 16:48:11.097');
...
INSERT INTO public.sys_ui_elements (id, parent_id, element_code, element_type, orders, param1, param2, param3, authority, description, created_at, remark, multilingual, route_path) VALUES('e186a671-8e24-143a-5a2c-27a1f5f38bf3', '5373a6a2-1861-af35-eb4c-adfd5ca55ecd', 'device_config-edit', 3, 1128, '/device/config-edit', '', '1', '["TENANT_ADMIN"]'::json, '设备配置编辑', '2024-03-11 21:49:34.952', '', 'route.device_config-edit', 'view.device_config-edit');
INSERT INTO public.sys_ui_elements (id, parent_id, element_code, element_type, orders, param1, param2, param3, authority, description, created_at, remark, multilingual, route_path) VALUES('a2c53126-029f-7138-4d7a-f45491f396da', '0', 'apply', 1, 3, '/apply', 'mdi:apps-box', '0', '["SYS_ADMIN"]'::json, '应用管理', '2024-02-18 17:59:31.642', '', 'route.apply', 'layout.base');
...
INSERT INTO public.sys_ui_elements (id, parent_id, element_code, element_type, orders, param1, param2, param3, authority, description, created_at, remark, multilingual, route_path) VALUES('5373a6a2-1861-af35-eb4c-adfd5ca55ecd', '0', 'device', 1, 112, '/device', 'icon-park-outline:workbench', '0', '["TENANT_ADMIN"]'::json, '设备接入', '2024-03-05 17:51:19.298', '', 'route.device', 'layout.base');
...
-- INSERT INTO public.sys_ui_elements (id, parent_id, element_code, element_type, orders, param1, param2, param3, authority, description, created_at, remark, multilingual, route_path) VALUES('04c523e3-5d60-8554-fd7f-11303ac8b8fe', 'e1ebd134-53df-3105-35f4-489fc674d173', 'management_role', 3, 1, '/management/role', 'ic:round-supervisor-account', '0', '["TENANT_ADMIN"]'::json, '角色管理', '2024-08-16 16:24:40.097', '', 'route.management_role', '');
...
-- INSERT INTO public.sys_ui_elements (id, parent_id, element_code, element_type, orders, param1, param2, param3, authority, description, created_at, remark, multilingual, route_path) VALUES('8251d887-d63e-9529-f645-c5393a6afae0', 'e1ebd134-53df-3105-35f4-489fc674d173', 'management_ordinary-user', 3, 1788, '/management/ordinary-user', 'ph:android-logo', '0', '["TENANT_ADMIN"]'::json, '用户管理', '2024-08-27 14:48:08.191', '', '', '');
